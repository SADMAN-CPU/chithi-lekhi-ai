...
export function LanguageSwitcher() {
  ...
  return (
    <button
      ...
      className="inline-flex items-center justify-center gap-1 sm:gap-1.5 px-2.5 h-10 rounded-xl text-xs font-semibold text-neutral-700 dark:text-neutral-200 bg-neutral-100/90 hover:bg-neutral-200/90 dark:bg-neutral-800/90 dark:hover:bg-neutral-700/90 border border-neutral-200/80 dark:border-neutral-700/80 hover:border-rose-300 dark:hover:border-rose-700 transition-all active:scale-95 min-w-[44px] min-h-[44px] cursor-pointer shrink-0 focus-visible:ring-2 focus-visible:ring-rose-400 focus-visible:outline-none"
    >
